...
{
    [TestClass]
    public class RateOfChangePercentageTest
    {
        #region Test data
        /// <summary>
        ...
        private readonly List<double> expected = new List<double>
        {
            ...
            // Since ROC = 100 * ROCP, we divide all values by 100.
            -0.00546,  // Index=14 value.
            -0.02109,  // Index=15 value.
            -0.0553,   // Index=16 value.
            -0.010367  // Index=251 (last) value.
        };
        #endregion
        ...
        {
            var target = new RateOfChangePercentage(5);
        ...
        {
            var target = new RateOfChangePercentage(5);
            Assert.AreEqual("RoC%5", target.Moniker);
            target = new RateOfChangePercentage(11);
            Assert.AreEqual("RoC%11", target.Moniker);
        }
        #endregion
        ...
        {
            var target = new RateOfChangePercentage(5);
            Assert.AreEqual("Rate of Change Percentage", target.Description);
        }
        #endregion
        ...
        public void ValueTest()
        {
            ...
            var target = new RateOfChangePercentage(14);
            for (int i = 0; i < 14; ++i)
            {
        ...
        {
            var target = new RateOfChangePercentage(11);
            Assert.AreEqual(11, target.Length);
            target = new RateOfChangePercentage(22);
        ...
        {
            const int digits = 4;
            List<double> actual = RateOfChangePercentage.Calculate(input, 14);
            for (int i = 0; i < 14; ++i)
        ...
        #region RateOfChangePercentageConstructorTest
        /// <summary>
        /// A test for RateOfChangePercentage Constructor.
        /// </summary>
        [TestMethod]
        public void RateOfChangePercentageConstructorTest()
        {
            var target = new RateOfChangePercentage(5);
            Assert.AreEqual(5, target.Length);
            Assert.IsTrue(double.IsNaN(target.Value));
            Assert.IsFalse(target.IsPrimed);
            target = new RateOfChangePercentage(1);
        ...
        public void RateOfChangePercentageConstructorTest2()
        {
            var target = new RateOfChangePercentage(0);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void RateOfChangePercentageConstructorTest3()
        {
            var target = new RateOfChangePercentage(-8);
            Assert.IsNotNull(target);
        }
        #endregion

        #region SerializationTest
        private static void SerializeTo(RateOfChangePercentage instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(RateOfChangePercentage), null, 65536, false, true, null);
        ...
        private static RateOfChangePercentage DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(RateOfChangePercentage), null, 65536, false, true, null);
            var instance = (RateOfChangePercentage)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        {
            double u; const int digits = 4;
            var source = new RateOfChangePercentage(14);
            for (int i = 0; i < 14; ++i)
            {
            ...
            u = Math.Round(expected[2], digits);
            Assert.AreEqual(u, d);
            const string fileName = "RateOfChangePercentageTest_1.xml";
            SerializeTo(source, fileName);
            RateOfChangePercentage target = DeserializeFrom(fileName);
