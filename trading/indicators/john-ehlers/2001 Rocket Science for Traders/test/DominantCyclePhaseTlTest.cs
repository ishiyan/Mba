...
{
    [TestClass]
    public class DominantCyclePhaseTlTest
    {
        #region Test data
        /// <summary>
        ...
        {
            var target = new DominantCyclePhaseTl();
        ...
        public void MonikerTest()
        {
            ...
            //target = new DominantCyclePhaseTl(4);
            //Assert.AreEqual("DCPh4", target.Moniker);
            target = new DominantCyclePhaseTl(3);
            Assert.AreEqual("DCPh3", target.Moniker);
            target = new DominantCyclePhaseTl(2);
        ...
        public void CalculateTest()
        {
            ...
            List<double> calculatedList = DominantCyclePhaseTl.Calculate(priceList);
            var target = new DominantCyclePhaseTl();
        ...
        /// </summary>
        [TestMethod]
        public void DominantCyclePhaseTlConstructorTest()
        {
            var target = new DominantCyclePhaseTl();
            Assert.AreEqual(4, target.SmoothingLength);
            ...
            target = new DominantCyclePhaseTl(OhlcvComponent.TypicalPrice);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.IsTrue(double.IsNaN(target.Value));
            Assert.IsFalse(target.IsPrimed);
            ...
            target = new DominantCyclePhaseTl(3, OhlcvComponent.OpeningPrice);
            Assert.AreEqual(3, target.SmoothingLength);
            Assert.IsTrue(double.IsNaN(target.Value));
            Assert.IsFalse(target.IsPrimed);
            ...
            target = new DominantCyclePhaseTl(2, OhlcvComponent.OpeningPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.IsTrue(double.IsNaN(target.Value));
            Assert.IsFalse(target.IsPrimed);
            Assert.IsTrue(target.OhlcvComponent == OhlcvComponent.OpeningPrice);
        ...
        public void DominantCyclePhaseTlConstructorTest2()
        {
            var target = new DominantCyclePhaseTl(5);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void DominantCyclePhaseTlConstructorTest3()
        {
            var target = new DominantCyclePhaseTl(1);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void DominantCyclePhaseTlConstructorTest4()
        {
            var target = new DominantCyclePhaseTl(0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void DominantCyclePhaseTlConstructorTest5()
        {
            var target = new DominantCyclePhaseTl(-8);
            Assert.IsFalse(target.IsPrimed);
        }
        #endregion

        #region SerializationTest
        private static void SerializeTo(DominantCyclePhaseTl instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(DominantCyclePhaseTl), null, 65536, false, true, null);
        ...
        private static DominantCyclePhaseTl DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(DominantCyclePhaseTl), null, 65536, false, true, null);
            var instance = (DominantCyclePhaseTl)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        {
            const int digits = 8;
            var source = new DominantCyclePhaseTl();
            // Tradestation-implementation skips first 9 bars.
            for (int i = 9; i < 111; ++i)
            {
            ...
            const string fileName = "DominantCyclePhaseTl_1.xml";
            SerializeTo(source, fileName);
            DominantCyclePhaseTl target = DeserializeFrom(fileName);
