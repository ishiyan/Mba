...
{
    [TestClass]
    public class MesaAdaptiveMovingAverageBandTlTest
    {
        #region Test data
        /// <summary>
        ...
        {
            var target = new MesaAdaptiveMovingAverageBandTl();
            Assert.AreEqual("MAMA/FAMA", target.Name);
        }
        #endregion
        ...
        {
            var target = new MesaAdaptiveMovingAverageBandTl();
            Assert.AreEqual("MAMA/FAMA4(3,39)", target.Moniker);
            target = new MesaAdaptiveMovingAverageBandTl(20, 5);
            Assert.AreEqual("MAMA/FAMA4(5,20)", target.Moniker);
            target = new MesaAdaptiveMovingAverageBandTl(0.01, 0.8);
            Assert.AreEqual("MAMA/FAMA4(1,199)", target.Moniker);
        }
        #endregion
        ...
        {
            var target = new MesaAdaptiveMovingAverageBandTl();
            Assert.AreEqual("Mesa / Following Adaptive Moving Average", target.Description);
        }
        #endregion
        ...
        public void SlowLimitTest()
        {
            ...
            target = new MesaAdaptiveMovingAverageBandTl(19, 7);
            Assert.AreEqual(0.1, target.SlowLimit);
            target = new MesaAdaptiveMovingAverageBandTl(0.01, 0.8);
        ...
        public void SlowLimitLengthTest()
        {
            ...
            target = new MesaAdaptiveMovingAverageBandTl(19, 7);
            Assert.AreEqual(19, target.SlowLimitLength);
            target = new MesaAdaptiveMovingAverageBandTl(0.01, 0.8);
        ...
        public void FastLimitLengthTest()
        {
            ...
            target = new MesaAdaptiveMovingAverageBandTl(20, 5);
            Assert.AreEqual(5, target.FastLimitLength);
            target = new MesaAdaptiveMovingAverageBandTl(0.01, 0.8);
        ...
        public void SmoothingLengthTest()
        {
            ...
            target = new MesaAdaptiveMovingAverageBandTl(4);
            Assert.AreEqual(4, target.SmoothingLength);
            target = new MesaAdaptiveMovingAverageBandTl(3);
            Assert.AreEqual(3, target.SmoothingLength);
            target = new MesaAdaptiveMovingAverageBandTl(2);
        ...
        public void UpdateTest()
        {
            ...
            const int digits = 9;
            var target = new MesaAdaptiveMovingAverageBandTl();
            // Tradestation implementation skips first 9 bars. Why?
            for (int i = 9; i < rawInput.Count; i++)
            {
                band = target.Update(rawInput[i], dateTime);
                double d = Math.Round(target.MamaValue, digits);
                double u = Math.Round(mama[i], digits);
                if (!double.IsNaN(d))
                    Assert.AreEqual(u, d);
                d = Math.Round(target.FamaValue, digits);
        ...
        /// </summary>
        [TestMethod]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest()
        {
            var target = new MesaAdaptiveMovingAverageBandTl();
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(OhlcvComponent.TypicalPrice);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            Assert.AreEqual(39, target.SlowLimitLength);
            Assert.AreEqual(0.5, target.FastLimit);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(2, OhlcvComponent.OpeningPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            Assert.AreEqual(39, target.SlowLimitLength);
            Assert.AreEqual(0.5, target.FastLimit);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(199, 7);
            Assert.AreEqual(4, target.SmoothingLength);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(199, 7, 2);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(199, 7, 2, OhlcvComponent.LowPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(0.01, 0.25);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(0.01, 0.25, 2);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new MesaAdaptiveMovingAverageBandTl(0.01, 0.25, 2, OhlcvComponent.HighPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
        ...
        public void MesaAdaptiveMovingAverageBandTlConstructorTest2()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(5);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest3()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(1);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest4()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest5()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(-8);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest6()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(0, 2);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest7()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(-7, 2);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest8()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(199, 0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest9()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(199, -7);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest10()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(1.01, 0.3);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest11()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(0, 0.3);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest12()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(-0.01, 0.3);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest13()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(0.3, 1.01);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest14()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(0.3, 0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void MesaAdaptiveMovingAverageBandTlConstructorTest15()
        {
            var target = new MesaAdaptiveMovingAverageBandTl(0.3, -0.01);
            Assert.IsFalse(target.IsPrimed);
        }
        #endregion

        #region SerializationTest
        private static void SerializeTo(MesaAdaptiveMovingAverageBandTl instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(MesaAdaptiveMovingAverageBandTl), null, 65536, false, true, null);
        ...
        private static MesaAdaptiveMovingAverageBandTl DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(MesaAdaptiveMovingAverageBandTl), null, 65536, false, true, null);
            var instance = (MesaAdaptiveMovingAverageBandTl)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        public void SerializationTest()
        {
            ...
            Band band;
            double d, u; const int digits = 9;
            var source = new MesaAdaptiveMovingAverageBandTl();
            // Tradestation implementation skips first 9 bars.
            for (int i = 9; i < 99; i++)
            {
                band = source.Update(rawInput[i], dateTime);
                d = Math.Round(source.MamaValue, digits);
                u = Math.Round(mama[i], digits);
                if (!double.IsNaN(d))
                    Assert.AreEqual(u, d);
                d = Math.Round(source.FamaValue, digits);
                u = Math.Round(fama[i], digits);
                if (!double.IsNaN(d))
                    Assert.AreEqual(u, d);
                if (i > 31)
            ...
            const string fileName = "MesaAdaptiveMovingAverageBandTl_1.xml";
            SerializeTo(source, fileName);
            MesaAdaptiveMovingAverageBandTl target = DeserializeFrom(fileName);
            Assert.AreEqual(source.MamaValue, target.MamaValue);
            Assert.AreEqual(source.FamaValue, target.FamaValue);
            for (int i = 99; i < rawInput.Count; i++)
            {
                band = target.Update(rawInput[i], dateTime);
                d = Math.Round(target.MamaValue, digits);
                u = Math.Round(mama[i], digits);
