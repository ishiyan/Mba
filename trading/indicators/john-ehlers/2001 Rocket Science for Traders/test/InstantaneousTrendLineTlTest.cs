...
{
    [TestClass]
    public class InstantaneousTrendLineTlTest
    {
        #region Test data
        /// <summary>
        ...
        {
            var target = new InstantaneousTrendLineTl();
        ...
        public void MonikerTest()
        {
            ...
            //target = new InstantaneousTrendLineTl(4);
            //Assert.AreEqual("ITL4", target.Moniker);
            target = new InstantaneousTrendLineTl(3);
            Assert.AreEqual("ITL3", target.Moniker);
            target = new InstantaneousTrendLineTl(2);
        ...
        public void CalculateTest()
        {
            ...
            List<double> calculatedList = InstantaneousTrendLineTl.Calculate(priceList);
            var target = new InstantaneousTrendLineTl();
        ...
        /// </summary>
        [TestMethod]
        public void InstantaneousTrendLineTlConstructorTest()
        {
            var target = new InstantaneousTrendLineTl();
            Assert.AreEqual(4, target.SmoothingLength);
            ...
            target = new InstantaneousTrendLineTl(OhlcvComponent.TypicalPrice);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.IsTrue(double.IsNaN(target.Value));
            Assert.IsFalse(target.IsPrimed);
            ...
            target = new InstantaneousTrendLineTl(3, OhlcvComponent.OpeningPrice);
            Assert.AreEqual(3, target.SmoothingLength);
            Assert.IsTrue(double.IsNaN(target.Value));
            Assert.IsFalse(target.IsPrimed);
            ...
            target = new InstantaneousTrendLineTl(2, OhlcvComponent.OpeningPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.IsTrue(double.IsNaN(target.Value));
            Assert.IsFalse(target.IsPrimed);
            Assert.IsTrue(target.OhlcvComponent == OhlcvComponent.OpeningPrice);
        ...
        public void InstantaneousTrendLineTlConstructorTest2()
        {
            var target = new InstantaneousTrendLineTl(5);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void InstantaneousTrendLineTlConstructorTest3()
        {
            var target = new InstantaneousTrendLineTl(1);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void InstantaneousTrendLineTlConstructorTest4()
        {
            var target = new InstantaneousTrendLineTl(0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void InstantaneousTrendLineTlConstructorTest5()
        {
            var target = new InstantaneousTrendLineTl(-8);
            Assert.IsFalse(target.IsPrimed);
        }
        #endregion

        #region SerializationTest
        private static void SerializeTo(InstantaneousTrendLineTl instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(InstantaneousTrendLineTl), null, 65536, false, true, null);
        ...
        private static InstantaneousTrendLineTl DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(InstantaneousTrendLineTl), null, 65536, false, true, null);
            var instance = (InstantaneousTrendLineTl)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        {
            double d, u; const int digits = 9;
            var source = new InstantaneousTrendLineTl();
            // Tradestation-implementation skips first 9 bars.
            for (int i = 9; i < 111; ++i)
            {
            ...
            const string fileName = "InstantaneousTrendLineTl_1.xml";
            SerializeTo(source, fileName);
            InstantaneousTrendLineTl target = DeserializeFrom(fileName);
