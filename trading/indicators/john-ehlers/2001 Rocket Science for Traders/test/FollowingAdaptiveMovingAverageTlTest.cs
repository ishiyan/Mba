...
{
    [TestClass]
    public class FollowingAdaptiveMovingAverageTlTest
    {
        #region Test data
        /// <summary>
        ...
        {
            var target = new FollowingAdaptiveMovingAverageTl();
        ...
        public void MonikerTest()
        {
            ...
            target = new FollowingAdaptiveMovingAverageTl(20, 5);
            Assert.AreEqual("FAMA4(5,20)", target.Moniker);
            target = new FollowingAdaptiveMovingAverageTl(0.01, 0.8);
        ...
        public void SlowLimitTest()
        {
            ...
            target = new FollowingAdaptiveMovingAverageTl(19, 7);
        ...
        public void SmoothingLengthTest()
        {
            ...
            target = new FollowingAdaptiveMovingAverageTl(4);
            Assert.AreEqual(4, target.SmoothingLength);
            target = new FollowingAdaptiveMovingAverageTl(3);
            Assert.AreEqual(3, target.SmoothingLength);
            target = new FollowingAdaptiveMovingAverageTl(2);
        ...
        public void CalculateTest()
        {
            ...
            List<double> calculatedList = FollowingAdaptiveMovingAverageTl.Calculate(priceList);
            var target = new FollowingAdaptiveMovingAverageTl();
            var updatedList = rawInput.Select(target.Update).ToList();
        ...
        /// </summary>
        [TestMethod]
        public void FollowingAdaptiveMovingAverageTlConstructorTest()
        {
            var target = new FollowingAdaptiveMovingAverageTl();
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            ...
            target = new FollowingAdaptiveMovingAverageTl(OhlcvComponent.TypicalPrice);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            Assert.AreEqual(39, target.SlowLimitLength);
            Assert.AreEqual(0.5, target.FastLimit);
            ...
            target = new FollowingAdaptiveMovingAverageTl(2, OhlcvComponent.OpeningPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(3, target.FastLimitLength);
            Assert.AreEqual(39, target.SlowLimitLength);
            Assert.AreEqual(0.5, target.FastLimit);
            ...
            target = new FollowingAdaptiveMovingAverageTl(199, 7);
            Assert.AreEqual(4, target.SmoothingLength);
            ...
            target = new FollowingAdaptiveMovingAverageTl(199, 7, 2);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new FollowingAdaptiveMovingAverageTl(199, 7, 2, OhlcvComponent.LowPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new FollowingAdaptiveMovingAverageTl(0.01, 0.25);
            Assert.AreEqual(4, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new FollowingAdaptiveMovingAverageTl(0.01, 0.25, 2);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
            ...
            target = new FollowingAdaptiveMovingAverageTl(0.01, 0.25, 2, OhlcvComponent.HighPrice);
            Assert.AreEqual(2, target.SmoothingLength);
            Assert.AreEqual(7, target.FastLimitLength);
            Assert.AreEqual(199, target.SlowLimitLength);
            Assert.AreEqual(0.25, target.FastLimit);
        ...
        public void FollowingAdaptiveMovingAverageTlConstructorTest2()
        {
            var target = new FollowingAdaptiveMovingAverageTl(5);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest3()
        {
            var target = new FollowingAdaptiveMovingAverageTl(1);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest4()
        {
            var target = new FollowingAdaptiveMovingAverageTl(0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest5()
        {
            var target = new FollowingAdaptiveMovingAverageTl(-8);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest6()
        {
            var target = new FollowingAdaptiveMovingAverageTl(0, 2);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest7()
        {
            var target = new FollowingAdaptiveMovingAverageTl(-7, 2);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest8()
        {
            var target = new FollowingAdaptiveMovingAverageTl(199, 0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest9()
        {
            var target = new FollowingAdaptiveMovingAverageTl(199, -7);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest10()
        {
            var target = new FollowingAdaptiveMovingAverageTl(1.01, 0.3);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest11()
        {
            var target = new FollowingAdaptiveMovingAverageTl(0, 0.3);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest12()
        {
            var target = new FollowingAdaptiveMovingAverageTl(-0.01, 0.3);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest13()
        {
            var target = new FollowingAdaptiveMovingAverageTl(0.3, 1.01);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest14()
        {
            var target = new FollowingAdaptiveMovingAverageTl(0.3, 0);
            Assert.IsFalse(target.IsPrimed);
        }
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void FollowingAdaptiveMovingAverageTlConstructorTest15()
        {
            var target = new FollowingAdaptiveMovingAverageTl(0.3, -0.01);
            Assert.IsFalse(target.IsPrimed);
        }
        #endregion

        #region SerializationTest
        private static void SerializeTo(FollowingAdaptiveMovingAverageTl instance, string fileName)
        {
            var dcs = new DataContractSerializer(typeof(FollowingAdaptiveMovingAverageTl), null, 65536, false, true, null);
        ...
        private static FollowingAdaptiveMovingAverageTl DeserializeFrom(string fileName)
        {
            var fs = new FileStream(fileName, FileMode.Open);
            XmlDictionaryReader reader = XmlDictionaryReader.CreateTextReader(fs, new XmlDictionaryReaderQuotas());
            var ser = new DataContractSerializer(typeof(FollowingAdaptiveMovingAverageTl), null, 65536, false, true, null);
            var instance = (FollowingAdaptiveMovingAverageTl)ser.ReadObject(reader, true);
            reader.Close();
            fs.Close();
            return instance;
        }
        ...
        {
            double d, u; const int digits = 9;
            var source = new FollowingAdaptiveMovingAverageTl();
            // Tradestation-implementation skips first 9 bars.
            for (int i = 9; i < 111; ++i)
            {
            ...
            const string fileName = "FollowingAdaptiveMovingAverageTl_1.xml";
            SerializeTo(source, fileName);
            FollowingAdaptiveMovingAverageTl target = DeserializeFrom(fileName);
