...
extern int e_period = 10;         //8-25
extern int normal_speed = 10;           //0-6
extern int e_type_data=0;
...
int init()
  {
   IndicatorShortName("Traders Dynamic Index frama2");
...
int start()
  {
   ...
   {
      RSIBuf[i] =  iCustom(Symbol(),Period(),"Frama2",e_period,normal_speed,e_type_data,0,i);
      MA = 0;
