...
void _computeLastNbBars( int lastBars )
  {
   ...
   switch( e_type_data )
     {
      case PRICE_CLOSE    : FRACTIONAL_BANDS( lastBars, Close ); break;
      case PRICE_OPEN     : FRACTIONAL_BANDS( lastBars, Open ); break;
      case PRICE_HIGH     : FRACTIONAL_BANDS( lastBars, High ); break;
      case PRICE_LOW      : FRACTIONAL_BANDS( lastBars, Low ); break;
