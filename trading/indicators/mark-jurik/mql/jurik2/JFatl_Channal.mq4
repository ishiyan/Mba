...
reset=1;JFilter=JJMASeries(0,0,Bars-1-nf,limit,Phase,Length,FILTER,k,reset);if(reset!=0)return(-1);
@Rezalt[k]=JFilter; 
//----+ 
UpperBuffer[k]=JFilter+Channal_width*Point/2;     
LowerBuffer[k]=JFilter-Channal_width*Point/2;
//----+         
}
return(0); 
} 
