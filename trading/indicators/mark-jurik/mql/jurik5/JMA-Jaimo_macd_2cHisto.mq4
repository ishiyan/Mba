...
//---- input parameters
extern int       Periods_JMA1 = 9;
extern int       AppliedPrice_JMA1 = 0;
//extern int       Offset_JMA1 = 0;
extern int       phase_JMA1=0;

extern int       Periods_JMA2 = 17;
extern int       AppliedPrice_JMA2 = 0;
extern int       phase_JMA2=0;

//extern int       Offset_JMA2 = 0;
...
//---- JMA indicators
   ...
   IndicatorShortName("Jaimo-JMA_macd ("+Periods_JMA1+","+Periods_JMA2+") ");  
...
int start() {
   ...
   JMA(1,Periods_JMA1,AppliedPrice_JMA1,phase_JMA1);
   JMA(2,Periods_JMA2,AppliedPrice_JMA2,phase_JMA2);
...
//   Print ("JMA is " + JMA + " shift is " + shift); 
     ExtMapBuffer2[shift]=JMA; 
  }  
            ExtMapBuffer3[shift]= ExtMapBuffer1[shift]-ExtMapBuffer2[shift]; 
   
            ExtMapBuffer4[shift]=0.0;  ExtMapBuffer5[shift]=0.0;
   
      if (ExtMapBuffer3[shift]>ExtMapBuffer3[shift+1])
            ExtMapBuffer4[shift]=ExtMapBuffer3[shift];
            
      if (ExtMapBuffer3[shift]<ExtMapBuffer3[shift+1])
            ExtMapBuffer5[shift]=ExtMapBuffer3[shift];
