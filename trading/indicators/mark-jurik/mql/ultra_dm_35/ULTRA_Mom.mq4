...
SetIndexBuffer(1,Dn);
   ...
   string short_name="ULTRA MOM(" + MOM_Per + ")";
...
for (int i = 0; i < BarCount; i++)
                     ...
                     for (int vLen = Len; vLen <= Len + Progression * Sensitivity; vLen = vLen + Progression)
                        {
                        zn0 = iCustom(NULL,0,"JMA_Mom",MOM_Per,vLen,0,BarCount,0,i);
                        zn1 = iCustom(NULL,0,"JMA_Mom",MOM_Per,vLen,0,BarCount,0,i + 1);
                        if (zn0 > zn1) 
                        sch1++; 
                        else 
                        sch2++;
