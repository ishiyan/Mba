...
static double dJurX.f1[1],dJurX.f2[1][2],dJurX.f3[1][2],dJurX.f4[1][2],dJurX.f5[1][2];
static double dJurX.f6[1][2],dJurX.Kg[1][2],dJurX.Hg[1][2],dJurX.F1[1][2],dJurX.F2[1][2];
static double dJurX.F3[1][2],dJurX.F4[1][2],dJurX.F5[1][2],dJurX.F6[1][2];
static double dJurX.VEL1,dJurX.VEL2,dJurX.OUT,dJurX.INPUT;
static int    nJurX.w [1][2],nJurX.T1[1][2],nJurX.T2[1][2];
//--+
...
if((nJurX.Tnew==nJurX.T2[nJurX.number][01])||(nJurX.bar==nJurX.MaxBar)) 
  {
   dJurX.f1[nJurX.number]=dJurX.F1[nJurX.number][1]; dJurX.f2[nJurX.number]=dJurX.F2[nJurX.number][1]; 
   dJurX.f3[nJurX.number]=dJurX.F3[nJurX.number][1]; dJurX.f4[nJurX.number]=dJurX.F4[nJurX.number][1]; 
   dJurX.f5[nJurX.number]=dJurX.F5[nJurX.number][1]; dJurX.f6[nJurX.number]=dJurX.F6[nJurX.number][1];
  }
  else
  {
  if((nJurX.Tnew==nJurX.T2[nJurX.number][02])||(nJurX.bar==nJurX.MaxBar)) 
  {
   dJurX.f1[nJurX.number]=dJurX.F1[nJurX.number][0]; dJurX.f2[nJurX.number]=dJurX.F2[nJurX.number][0]; 
   dJurX.f3[nJurX.number]=dJurX.F3[nJurX.number][0]; dJurX.f4[nJurX.number]=dJurX.F4[nJurX.number][0]; 
   dJurX.f5[nJurX.number]=dJurX.F5[nJurX.number][0]; dJurX.f6[nJurX.number]=dJurX.F6[nJurX.number][0];

   dJurX.F1[nJurX.number][1]=dJurX.F1[nJurX.number][0]; dJurX.F2[nJurX.number][1]=dJurX.F2[nJurX.number][0]; 
   dJurX.F3[nJurX.number][1]=dJurX.F3[nJurX.number][0]; dJurX.F4[nJurX.number][1]=dJurX.F4[nJurX.number][0]; 
   dJurX.F5[nJurX.number][1]=dJurX.F5[nJurX.number][0]; dJurX.F6[nJurX.number][1]=dJurX.F6[nJurX.number][0];
  }
  else   
  {
   nJurX.reset=-1;
...
if (nJurX.bar==1)
{
nJurX.T2[nJurX.number][0]=Time[2];
nJurX.T1[nJurX.number][0]=Time[1];
dJurX.F1[nJurX.number][0]=dJurX.f1[nJurX.number]; 
dJurX.F2[nJurX.number][0]=dJurX.f2[nJurX.number]; 
dJurX.F3[nJurX.number][0]=dJurX.f3[nJurX.number]; 
dJurX.F4[nJurX.number][0]=dJurX.f4[nJurX.number]; 
dJurX.F5[nJurX.number][0]=dJurX.f5[nJurX.number]; 
dJurX.F6[nJurX.number][0]=dJurX.f6[nJurX.number];
}
//+--- 
if (nJurX.bar==2)
{
nJurX.T2[nJurX.number][1]=Time[2];
nJurX.T1[nJurX.number][1]=Time[1];
dJurX.F1[nJurX.number][1]=dJurX.f1[nJurX.number]; 
dJurX.F2[nJurX.number][1]=dJurX.f2[nJurX.number]; 
dJurX.F3[nJurX.number][1]=dJurX.f3[nJurX.number]; 
dJurX.F4[nJurX.number][1]=dJurX.f4[nJurX.number]; 
dJurX.F5[nJurX.number][1]=dJurX.f5[nJurX.number]; 
dJurX.F6[nJurX.number][1]=dJurX.f6[nJurX.number];
}
